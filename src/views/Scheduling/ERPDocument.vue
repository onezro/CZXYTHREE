        ...
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            <el-form ref="formRef" :inline="true" size="small" label-width="auto" @submit.native.prevent>
                <el-form-item :label="t('Scheduling.assist.productOrder')" prop="productOrder" class="mb-2">
                    <el-input v-model="getForm.productOrder" placeholder="" clearable @clear="getData"
            ...
            <el-table :data="tableData.slice(
                ...
                <el-table-column :label="t('Scheduling.ERPDocument.ProductOrder')" fixed  prop="productOrder"
                    :min-width="getColumnWidth1('productOrder')" />
                <el-table-column :label="t('Scheduling.ERPDocument.LineNum')" fixed prop="lineNum"
                    :min-width="getColumnWidth1('lineNum')" />
                <el-table-column :label="t('Scheduling.ERPDocument.ProductCode')" fixed prop="productCode"
                    :min-width="getColumnWidth1('productCode')" />
                <el-table-column :label="t('Scheduling.ERPDocument.ProductName')" fixed prop="ProductName"
                    :min-width="getColumnWidth1('ProductName')" />    
                <el-table-column :label="t('Scheduling.ERPDocument.Specification')" prop="Specification"
                    :min-width="getColumnWidth1('Specification')" />
                <el-table-column :label="t('Scheduling.ERPDocument.ProductVersion')" prop="ProductVersion"
                    :min-width="getColumnWidth1('ProductVersion')" />
                <el-table-column :label="t('Scheduling.ERPDocument.ProductNum')" prop="ProductNum"
                    :min-width="getColumnWidth1('ProductNum')" />
               
                <el-table-column :label="t('Scheduling.ERPDocument.PreparationOrder')" prop="PreparationOrder"
                    :min-width="getColumnWidth1('PreparationOrder')" />
                <el-table-column :label="t('Scheduling.ERPDocument.Status')" prop="Status"
                    :min-width="getColumnWidth1('Status')" />
                <el-table-column :label="t('Scheduling.ERPDocument.MesOrder')" prop="mesOrder"
                ...
                <el-table-column :label="t('Scheduling.ERPDocument.Creatime')" prop="creatime"
...
const columnWidths1 = computed(() => {
    const columns = [
        { label: t("Scheduling.assist.productOrder"), prop: "productOrder" },
        { label: t("Scheduling.assist.lineNum"), prop: "lineNum" },
        { label: t("Scheduling.assist.productCode"), prop: "productCode" },
        { label: t("Scheduling.assist.ProductName"), prop: "ProductName" },
        { label: t("Scheduling.assist.Specification"), prop: "Specification" },
        { label: t("Scheduling.assist.ProductVersion"), prop: "ProductVersion" },
