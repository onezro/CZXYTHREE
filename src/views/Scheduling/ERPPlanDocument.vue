    ...
    <div class="p-2">
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            ...
            <el-table :data="tableData.slice(
                ...
                <el-table-column :label="t('Scheduling.assist.productOrder')" fixed  prop="productOrder"
                    :min-width="getColumnWidth1('productOrder')" />
                <el-table-column :label="t('Scheduling.assist.lineNum')" fixed prop="lineNum"
                    :min-width="getColumnWidth1('lineNum')" />
                <el-table-column :label="t('Scheduling.assist.productCode')" fixed prop="productCode"
                    :min-width="getColumnWidth1('productCode')" />
                <el-table-column :label="t('Scheduling.assist.ProductName')" fixed prop="ProductName"
                    :min-width="getColumnWidth1('ProductName')" />    
                <el-table-column :label="t('Scheduling.assist.Specification')" prop="Specification"
                    :min-width="getColumnWidth1('Specification')" />
                <el-table-column :label="t('Scheduling.assist.ProductVersion')" prop="ProductVersion"
