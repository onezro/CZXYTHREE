...
const INITIAL_RAW_DATA = [
  { line: "SMT-1", target: 1200, actual: 100, uph: 120, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.33%" },
  { line: "SMT-2", target: 1300, actual: 120, uph: 130, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "9.23%" },
  { line: "SMT-3", target: 1125, actual: 85, uph: 102, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "7.56%" },
  { line: "SMT-4", target: 1200, actual: 100, uph: 100, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.33%" },
  { line: "SMT-5", target: 900, actual: 75, uph: 78, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.33%" },
  { line: "SMT-6", target: 1100, actual: 92, uph: 95, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.36%" },
  { line: "SMT-7", target: 1200, actual: 96, uph: 98, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.00%" },
  { line: "SMT-8", target: 1400, actual: 115, uph: 118, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.21%" },
  { line: "SMT-9", target: 1400, actual: 116, uph: 118, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.29%" },
  { line: "SMT-10", target: 1350, actual: 112, uph: 115, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.30%" },
  { line: "SMT-11", target: 1200, actual: 98, uph: 100, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.17%" },
  { line: "SMT-12", target: 1600, actual: 130, uph: 132, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.13%" },
  { line: "SMT-13", target: 1420, actual: 118, uph: 120, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.31%" },
  { line: "SMT-14", target: 1280, actual: 105, uph: 110, fpy: "99.98%", spi: "99.99%", aoi: "99.99%", rate: "8.20%" },
];
